			...
			<div class="col-xl-10">
				<div class="card border-0">
					<div class="card-body p-0">
						...
						<input name="email" type="text" value="" class="form-control" id="exampleInputEmail1" required="required">
										</div>
								...
								<%}
								   ...
								   %>	
									<form action="customerlogin" method="post">
										<div class="form-group">
											<label for="exampleInputEmail1">Email</label> 
						<input name="email" type="text" value="<%=al.get(0)%>" class="form-control" id="exampleInputEmail1" required="required">
										</div>
										<div class="form-group mb-5">
											<label for="exampleInputPassword1">Password</label> 
